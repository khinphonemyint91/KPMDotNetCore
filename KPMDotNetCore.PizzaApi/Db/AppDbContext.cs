using KPMDotNetCore.PizzaApi;
using Microsoft.EntityFrameworkCore;
using System.ComponentModel.DataAnnotations;
using System.ComponentModel.DataAnnotations.Schema;

namespace KPMDotNetCore.PizzaApi.Db
{
    internal class AppDbContext : DbContext
    {
        ...
        public DbSet<PizzaExtraModel> PizzasExtra { get; set; }
        public DbSet<PizzaOrderModel> PizzasOrder { get; set;}
        public DbSet<PizzaOrderDetailModel> PizzasOrderDetail { get; set; }
    }
    ...
    public class PizzaExtraModel
    {
        ...
        [NotMapped]
        public string PriceStar { get { return "$ " + Price; } }
    }
